        ...
        <div class="settings-section__heading-main">
          ...
          <div class="settings-section__heading-copy">
            ...
            <p class="settings-section__description">
              ...
              проверенный набор файлов локально и при следующем запуске поднимает его без сети.
              Если браузер очистит хранилище, модель нужно будет загрузить заново. Выбор другой
              модели приостановит текущую загрузку.
            </p>
          </div>
        </div>
      </header>
