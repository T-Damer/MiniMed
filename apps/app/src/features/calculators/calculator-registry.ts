...
export const CALCULATOR_REGISTRY: readonly CalculatorDefinition[] = [
  ...
  },
  {
    ...
    population: 'Беременные с точно известной датой начала последней менструации и регулярным циклом.',
    limitations: [
  ...
  },
  {
    ...
    category: 'obstetrics',
    clinical: true,
    formula: 'ПДР = дата первого шевеления + 22 нед (первобеременные) или + 24 нед (повторнобеременные)',
  ...
  },
  {
    ...
    limitations: ['Точность полностью зависит от точности исходного срока, введённого пользователем.'],
    inputs: [
  ...
  },
  {
    ...
    summary: 'Обратный расчёт: по известной ПДР — срок беременности на сегодня или на заданную дату.',
    audience: 'adult',
    category: 'obstetrics',
    clinical: true,
  ...
  },
  {
    ...
    summary: 'Срок беременности по БПР, ОГ, ОЖ и/или ДБ — среднее однопараметрических формул Hadlock 1984.',
    audience: 'adult',
    category: 'obstetrics',
    clinical: true,
    formula: 'Hadlock, 1984: отдельные регрессии по БПР/ОГ/ОЖ/ДБ (см); итог — среднее указанных оценок',
  ...
  },
  {
    ...
    category: 'obstetrics',
    clinical: true,
    formula: 'Bishop, 1964: сумма баллов по раскрытию, сглаживанию, станции головки, консистенции и позиции шейки',
    population: 'Беременные перед плановой индукцией родов, когда оценивается зрелость шейки матки.',
    limitations: [
  ...
  },
  {
    ...
    summary: 'Процентили роста плода и индексы допплерометрии (ПИ/ИР пуповинной и средней мозговой артерий).',
    audience: 'adult',
    category: 'obstetrics',
    clinical: true,
    sourceRequirement:
