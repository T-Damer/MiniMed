...
export const EGOGRAM_ASSESSMENT: AssessmentDefinition = {
  ...
  evidenceNote:
    'Опросник основан на концепции эгограммы в транзактном анализе, но его вопросы и пороги являются авторской версией MiniMed и не заменяют валидированные инструменты.',
  license: {
    kind: 'project-original',
    notice:
      'Авторская формулировка MiniMed; не воспроизводит коммерческие или валидированные бланки эгограмм.',
  },
};
