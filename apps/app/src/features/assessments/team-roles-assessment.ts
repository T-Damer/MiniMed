...
export const TEAM_ROLES_ASSESSMENT: AssessmentDefinition = {
  ...
  evidenceNote:
    'Названия ролей сопоставлены с моделью Белбина. Вопросы и подсчёт этой версии подготовлены MiniMed для обсуждения командного вклада; официальная методика Belbin включает лицензируемый SPI и, как правило, наблюдения коллег.',
  license: {
    kind: 'project-original',
    notice:
      'Образовательная адаптация для обсуждения командных ролей; не воспроизводит, не переводит и не модифицирует Belbin Self-Perception Inventory.',
