...
// __android_log_is_loggable() needs API 30+; this module's minSdk is 24, so log level
// filtering below relies only on the compile-time LOG_MIN_LEVEL guards around each macro.
