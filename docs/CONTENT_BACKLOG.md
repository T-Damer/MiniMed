...
- неонатальный, пренатальный и детский профилактический скрининг — 🧪 частично закрыто:
  детский профилактический график структурирован из приказа №211н (2025);
  текущий неонатальный/расширенный скрининг структурирован из приказа №274н с поправкой №745н,
  действующей с 01.04.2026:
  `docs/research/data/neonatal-screening-order-274n-current-2026.json`.
  Добавления 2026 (AADC и X-ALD) versioned отдельно; screen-positive ≠ диагноз.
  Пренатальный скрининг остаётся отдельным незакрытым source slice.
