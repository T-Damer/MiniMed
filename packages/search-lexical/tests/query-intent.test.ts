...
const cases = [
  ...
  ['Грудничок после насморка кашляет и свистит, ест хуже — нужен ли ему антибиотик', 'treatment'],
  [
    'У ребенка водянистый стул и температура без крови в кале — нужны ли антибактериальные препараты',
    'treatment',
  ],
  [
    'Ребенок с кашлем и температурой получает амоксициллин второй день, улучшения нет — что пересмотреть',
    'treatment',
  ],
  ['Ребенка рвет и водянистый стул — чем лучше отпаивать', 'treatment'],
