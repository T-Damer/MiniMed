...
@pytest.mark.parametrize("value", [
    "http://www.msdmanuals.com/ru/test", "https://other.test/ru/test",
    "https://user:secret@www.msdmanuals.com/ru/test", "https://www.msdmanuals.com:90/test",
    ORIGIN + "/a/../b", ORIGIN + "/a/%2e%2e/b", ORIGIN + "/a/%252e%252e/b",
    ORIGIN + "/ru/test#fragment", ORIGIN + "/ru/te\x00st", ORIGIN + "/a\\b",
])
