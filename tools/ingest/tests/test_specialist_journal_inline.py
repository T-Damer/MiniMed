...
def test_inline_citations_and_emphasis_stay_in_one_source_run() -> None:
    html = (
        "<div>Синдром <b>примера</b> — синтетическое описание "
...
def test_nested_block_elements_still_have_individual_ordered_units() -> None:
    units, _ = source_units(
        "<div>Перед <b>разделом</b><h3>Раздел</h3><p>Первый.</p><p>Второй.</p></div>", "#tabs-2"
    )
