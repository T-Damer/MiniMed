...
const benchmarkEnv = process.env as {
  readonly MINIMED_CLINICIAN_BENCHMARK_DB?: string;
...
const databasePath = resolve(
  root,
  benchmarkEnv.MINIMED_CLINICIAN_BENCHMARK_DB ?? 'data/build/private-pilot.db',
);
const modeValue = benchmarkEnv.MINIMED_CLINICIAN_BENCHMARK_MODE ?? 'hybrid';
