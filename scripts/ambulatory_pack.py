...
META: dict[str, dict[str, object]] = {
    ...
    "lor.bogomilsky": {
        "title": "Детская оториноларингология (Богомильский)",
        "short_title": "ЛОР Богомильский",
    ...
    "ft.moiseev_t1": {
        "title": "Внутренние болезни (Моисеев), том 1",
        "short_title": "Моисеев Т1",
        "specialties": ["internal-medicine"],
        "age_groups": ["adults"],
    },
    "ft.moiseev_t2": {
        "title": "Внутренние болезни (Моисеев), том 2",
        "short_title": "Моисеев Т2",
        "specialties": ["internal-medicine"],
        "age_groups": ["adults"],
    },
    "ftiz.table": {
    ...
    "ftiz.lozovskaya": {
        "title": "Фтизиатрия (Лозовская)",
        "short_title": "Фтиза Лозовская",
        "specialties": ["phthisiology"],
        "age_groups": ["children", "adults"],
    },
    "psych.chastnaya": {
    ...
    "trauma.kotelnikov": {
        "title": "Травматология и ортопедия (Котельников, 2021)",
        "short_title": "Травма Котельников",
        "specialties": ["traumatology", "orthopedics"],
        "age_groups": ["children", "adults"],
    },
    "neo.volodin_nr": {
        "title": "Неонатология — национальное руководство (Володин)",
        "short_title": "Нео Володин",
    ...
    "neo.shabalov": {
        "title": "Неонатология (Шабалов, 2016) — переходные состояния и нормы",
        "short_title": "Нео Шабалов",
