...
export const ANDROID_APK_NAME = `MiniMed-${RELEASE_VERSION}-rf-public-pilot-debug.apk`;
export const ANDROID_APK_URL = `${GITHUB_REPOSITORY_URL}/releases/download/${RELEASE_TAG}/${ANDROID_APK_NAME}`;
